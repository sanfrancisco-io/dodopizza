...
const OutBeverageTable = () => {
    const { beverage, getBeverages, deleteBeverages } = useContext(adminContext)
    useEffect(() => {
        getBeverages()
    }, [])
    return (
                            ...
                            <TableBody>
                                {
                                    beverage.map((item, index) => (
                                        <TableRow key={item.id}>
                                            ...
                                            <TableCell align="left" ><Button className='button-table' align="left" onClick={() => deleteBeverages(item.id)} variant="contained" color="primary">
                                                Удалить
                                            </Button>
                                            </TableCell>
                                            <TableCell align="left" >
...
export default OutBeverageTable;