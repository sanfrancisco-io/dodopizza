...
const OutSnacksTable = () => {
    const { snack, getSnacks, deleteSnacks } = useContext(adminContext)
    useEffect(() => {
        getSnacks()
    }, [])
    return (
                            ...
                            <TableBody>
                                {
                                    snack.map((item, index) => (
                                        <TableRow key={item.id}>
                                            ...
                                            <TableCell align="left" ><Button className='button-table' align="left" onClick={() => deleteSnacks(item.id)} variant="contained" color="primary">
                                                Удалить
                                            </Button>
                                            </TableCell>
                                            <TableCell align="left" >
                                                <Link to={`/edit/snacks/${item.id}`}>
