...
const OutPizzasTable = () => {
    const { dessert, getDesserts, deleteDesserts } = useContext(adminContext)
    useEffect(() => {
        getDesserts()
    }, [])
    return (
                            ...
                            <TableBody>
                                {
                                    dessert.map((item, index) => (
                                        <TableRow key={item.id}>
                                            ...
                                            <TableCell align="left" ><Button className='button-table' align="left" onClick={() => deleteDesserts(item.id)} variant="contained" color="primary">
                                                Удалить
                                            </Button>
                                            </TableCell>
                                            <TableCell align="left" >
                                                <Link to={`/edit/desserts/${item.id}`}>
