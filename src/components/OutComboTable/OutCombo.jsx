...
const OutCombo = () => {
    const { combo, getCombo, deleteCombo } = useContext(adminContext)
    useEffect(() => {
        getCombo()
    }, [])
    return (
                            ...
                            <TableBody>
                                {
                                    combo.map((item, index) => (
                                        <TableRow key={item.id}>
                                            ...
                                            <TableCell align="left" ><Button className='button-table' align="left" onClick={() => deleteCombo(item.id)} variant="contained" color="primary">
                                                Удалить
                                            </Button>
                                            </TableCell>
                                            <TableCell align="left" >
