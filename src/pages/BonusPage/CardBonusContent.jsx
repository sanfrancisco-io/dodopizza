...
export default function CardBonusContent() {
    ...
    return (
        <Card className={classes.root} sx={{ maxWidth: 345 }}>
            <CardMedia
                ...
                alt="bonus"
                height="140"
                image="https://dodopizza-a.akamaihd.net/static/Img/BonusActionBanners/Gallery/g_1632713265_3f7171c367ee478ba64321225b555119.jpeg"
            />
            <CardContent>
