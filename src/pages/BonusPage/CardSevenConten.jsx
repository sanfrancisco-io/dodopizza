...
export default function CardSevenConten() {
    ...
    return (
        <Card className={classes.root} sx={{ maxWidth: 345 }}>
            <CardMedia
                ...
                alt="bonus"
                height="140"
                image="https://dodopizza-a.akamaihd.net/static/Img/BonusActionBanners/Gallery/g_1626132628_b82a842a073a40d4acde0ec863cb6230.jpeg"
            />
            <CardContent>
