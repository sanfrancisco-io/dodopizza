...
export default function CardThirdContent() {
    ...
    return (
        <Card className={classes.root} sx={{ maxWidth: 345 }}>
            <CardMedia
                ...
                alt="bonus"
                height="140"
                image="https://dodopizza-a.akamaihd.net/static/Img/BonusActionBanners/Gallery/482cfd6e29bb485ab9898e3480762a73.jpeg"
            />
            <CardContent>
